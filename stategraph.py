...
Graph.read_json_file("ending.json")
...
for node_id in maze_nodes:
    ...
    @Graph.edge(node_id, "maze_exit", label="Setze die Fragmente zusammen")
    def edge(s):
...
Graph.edge("ktane_exit_A", "maze_0_1", label="Ich suche das andere Fragment")
Graph.edge("ktane_exit_B", "maze_10_0", label="Ich suche das andere Fragment")
